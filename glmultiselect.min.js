...
angular.module("glMultiSelect", [ "localytics.directives" ]), angular.module("glMultiSelect").directive("glMultiSelect", [ "$compile", "$timeout", function(a) {
    "use strict";
    return {
        restrict: "E",
        scope: {
        ...
        link: function(b, c) {
            function d() {
                c.children().remove(), b.api._data.editable = !0;
                b.api._data.optionsMaxHeight, angular.isUndefined(b.api._data.multiple) ? "" : "multiple";
                k = '<select class="jason" style="width: 100%;" chosen ' + q + ' data-ng-model="api._data.value" data-ng-options="option.value as option.label group by option.group for option in api._data.options"><option value=""></option></select>', 
                h = angular.element(k), //elementSelect.chosen({inherit_select_classes:true});
                c.append(a(h)(n)), g(), h.on("chosen:ready", function() {
            ...
            angular.forEach(p, function(a, c) {
                angular.isUndefined(b.settings[c]) || 1 != b.settings[c] || angular.isUndefined(a) || (q += a + " ");
            }), angular.isString(b.settings.placeholder) && (q += 'data-placeholder="' + b.settings.placeholder + '" '), 
            ...
            }, b.$watch("api._data.value", function(a, c) {
                angular.isFunction(b.api._data.onChange) && (b.api._data.onChange(a, c), e(a));
            }), // INIT

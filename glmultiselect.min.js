...
angular.module("glMultiSelect", [ "glChosen" ]), angular.module("glMultiSelect").directive("glMultiSelect", [ "$compile", "$timeout", function(a) {
    ...
    return {
        ...
        link: function(b, c) {
            function d() {
                c.children().remove(), b.api._data.editable = !0, k = '<select class="jason" style="width: 100%;" chosen ' + q + ' data-ng-model="api._data.value" data-ng-options="option.value as option.label group by option.group for option in api._data.options"><option value=""></option></select>', 

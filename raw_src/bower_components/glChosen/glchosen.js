...
angular.module("glChosen", []), angular.module("glChosen", []), angular.module("glChosen").directive("chosen", [ "$timeout", function($timeout) {
    var CHOSEN_OPTION_WHITELIST, NG_OPTIONS_REGEXP, isEmpty, snakeCase, __indexOf = [].indexOf || function(item) {
